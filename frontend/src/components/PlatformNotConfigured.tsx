...
/**
 * What the semester pages say when this deployment has no Student Hub behind them.
 *
 * Timetables live in the SCEN Student Hub, which is a separate deployment. Only the
  ...
  return (
    <section className="rounded-lg border border-[#d9dee7] bg-white p-6">
      ...
      <p className="mt-3 max-w-2xl text-sm leading-6 text-[#667085]">
        This deployment has no connection to the SCEN Student Hub. Set{" "}
